...
**Note:** Screenshots are automatically generated and saved to `test-results/` folder. See [README_TEST_RESULTS.md](./README_TEST_RESULTS.md) for automated testing.

#### 1. Home Page (`/`)
- **File**: `test-results/01-home-page.png`
- **What to show**: 
...
- **Files**: 
  - `test-results/02-create-session-empty.png` - Empty form
  - `test-results/02-create-session-filled.png` - Filled form
  - `test-results/02-create-session-round-robin.png` - With round robin enabled
- **What to show**:
...
- **Files**:
  - `test-results/03-session-stats-empty.png` - No games yet
  - `test-results/03-session-stats-with-games.png` - With games recorded
- **What to show**:
  - Session header
...
- **Files**:
  - `test-results/04-session-record-empty.png` - Empty form
  - `test-results/04-session-record-teams-selected.png` - Teams selected
  - `test-results/04-session-record-ready.png` - Ready to save
- **What to show**:
  - Game entry form
...
- **File**: `test-results/05-session-history.png`
- **What to show**:
...
- **File**: `test-results/06-summary-page.png`
...
5. Add screenshots to git: `git add docs/screenshots/test-results/*.png`
