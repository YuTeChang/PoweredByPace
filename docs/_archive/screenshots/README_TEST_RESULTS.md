...
This document describes the automated screenshot testing for VibeBadminton.

**Note:** All screenshots are located in the [test-results/](test-results/) subdirectory.
